module.exports = nativeDescription: "فارسی", englishDescription: "Persian", translation:
  ...
  new_home:
#    title: "CodeCombat - برنامه نویسی برای یادگیری پایتون و جاوا اسکریپت"
#    meta_keywords: "CodeCombat ، پایتون ،جاوا اسکریپت ، بازی های کد نویسی"
#    meta_description: "یادگیری کد تایپ شده از طریق یک بازی برنامه نویسی. هنگام حل معماها پایتون ، جاوا اسکریپت و HTML را بیاموزید و یاد بگیرید چگونه بازی ها و وب سایت های برنامه نویسی خود را بسازید."
#    meta_og_url: "https://codecombat.com"
#    become_investor: "برای تبدیل شدن به یک سرمایه گذار در CodeCombat"
#    built_for_teachers_title: "یک بازی برنامه نویسی ساخته شده با معلم در ذهن"
#    built_for_teachers_blurb: "آموزش کد نویسی به بچه ها اغلب بسیار طاقت فرسا است. CodeCombat به همه مربیان کمک می کند تا به دانش آموزان نحوه کد نویسی به دو زبان جاوا اسکریپت یا پایتون ، دو زبان محبوب برنامه نویسی را آموزش دهند. با یک برنامه درسی جامع که شامل شش واحد علوم رایانه است و یادگیری را از طریق توسعه بازی های مبتنی بر پروژه و واحدهای توسعه وب تقویت می کند ، بچه ها در سفری از نحو اصلی تا بازگشت حرکت خواهند کرد!"
#    built_for_teachers_subtitle1: "علوم کامپیوتر"
#    built_for_teachers_subblurb1: "با شروع دوره آشنایی رایگان با علوم کامپیوتر ، دانش آموزان بر مفاهیم اصلی برنامه نویسی مانند while/for حلقه ها ، توابع و الگوریتم ها تسلط دارند."
#    built_for_teachers_subtitle2: "توسعه بازی"
#    built_for_teachers_subblurb2: "زبان آموزان پیچ و خم می سازند و از ورودی اصلی برای کدگذاری بازی های خود استفاده می کنند که می تواند با دوستان و خانواده به اشتراک گذاشته شود."
#    built_for_teachers_subtitle3: "توسعه وب"
#    built_for_teachers_subblurb3: "با استفاده از HTML ، CSS و jQuery ، زبان آموزان عضلات خلاق خود را برای برنامه نویسی صفحات وب خود با یک URL سفارشی برای اشتراک گذاری با همکلاسی های خود انعطاف می دهند."
#    century_skills_title: "مهارتهای قرن 21"
#    century_skills_blurb1: "دانش آموزان فقط قهرمان خود را ارتقا نمی دهند ، بلکه خود را نیز ارتقاء می دهند"
#    century_skills_quote1: "شما به هم می ریزید ... بنابراین سپس به همه راه های ممکن برای رفع آن فکر می کنید و سپس دوباره امتحان کنید. بدون تلاش زیاد نمی توانم به اینجا برسم."
#    century_skills_subtitle1: "تفکر انتقادی"
#    century_skills_subblurb1: "بازی برنامه نویسی CodeCombat با رمزگذاری پازل هایی که به طور طبیعی در سطوح چالش برانگیزی قرار دارند ، تضمین می کند که بچه ها همیشه تفکر انتقادی را تمرین می کنند."
#    century_skills_quote2: "بقیه در حال پیچ و خم بودند ، بنابراین من فکر کردم ، "پرچم را بگیر" و این همان کاری بود که من انجام دادم."
#    century_skills_subtitle2: "خلاقیت"
#    century_skills_subblurb2: "CodeCombat دانش آموزان را تشویق می کند تا با ایجاد و به اشتراک گذاری بازی ها و صفحات وب خود ، خلاقیت خود را به نمایش بگذارند."
#    century_skills_quote3: "اگر در سطحی گیر کرده باشم. تا زمانی که همه ما نتوانستیم آن را بفهمیم ، با اطرافیانم کار می کردم."
#    century_skills_subtitle3: "Collaboration"
#    century_skills_subblurb3: "در طول بازی ، فرصت هایی برای دانش آموزان وجود دارد که هنگام گیر افتادن همکاری کنند و با هم از راهنمای برنامه نویسی جفت ما استفاده کنند."
#    century_skills_quote4: "من همیشه آرزوهایی برای طراحی بازی های ویدئویی و یادگیری نحوه کدگذاری داشتم ... این به من یک نقطه شروع عالی می دهد."
#    century_skills_quote4_author: "جوی ، کلاس دهم"
#    century_skills_subtitle4: "ارتباطات"
#    century_skills_subblurb4: "برنامه نویسی کودکان را ملزم به تمرین شیوه های جدید ارتباطی می کند ، از جمله برقراری ارتباط با خود کامپیوتر و انتقال ایده های خود با استفاده از کارآمدترین کد."
#    classroom_in_box_title: "ما تلاش می کنیم تا:"
#    classroom_in_box_blurb1: "هر دانش آموز را طوری درگیر کنید که آنها فکر کنند برنامه نویسی برای آنها مناسب است."
#    classroom_in_box_blurb2: "به هر مربی قدرت دهید که در هنگام آموزش کد نویسی احساس اعتماد به نفس کند."
#    classroom_in_box_blurb3: "از همه رهبران مدارس برای ایجاد یک برنامه علوم کامپیوتر در سطح جهانی الهام بگیرید."
#    classroom_in_box_blurb4: ""
#    click_here: "Click here"
#    creativity_rigor_title: "جایی که خلاقیت با شدت برخورد می کند"
#    creativity_rigor_subtitle1: "برنامه نویسی را سرگرم کننده کنید و مهارت های دنیای واقعی را آموزش دهید"
#    creativity_rigor_blurb1: "دانش آموزان هنگام انجام بازی هایی که آزمون و خطا ، تفکر انتقادی و خلاقیت را تشویق می کنند ، پایتون و جاوا اسکریپت واقعی را تایپ می کنند. سپس دانش آموزان مهارت های برنامه نویسی را که آموخته اند با توسعه بازی ها و وب سایت های خود در دوره های مبتنی بر پروژه به کار می گیرند."
#    creativity_rigor_subtitle2: "به دانش آموزان در سطح خود برسید"
#    creativity_rigor_blurb2: "هر سطح CodeCombat بر اساس میلیون ها نقطه داده داربست شده و برای انطباق با هر زبان آموز بهینه شده است. سطوح تمرین و نکات به دانش آموزان در هنگام گیر افتادن کمک می کند و سطوح چالشی میزان یادگیری دانش آموزان را در طول بازی ارزیابی می کند."
#    creativity_rigor_subtitle3: "ساخته شده برای همه معلمان ، صرف نظر از تجربه"
#    creativity_rigor_blurb3: "برنامه درسی CodeCombat که مطابق با استانداردها تنظیم شده است ، آموزش علوم کامپیوتر را برای همه ممکن می سازد. CodeCombat معلمان را با آموزش ، منابع آموزشی و پشتیبانی اختصاصی مجهز می کند تا در کلاس درس احساس اطمینان و موفقیت کنند."
#    featured_partners_title1: "برجسته در"
#    featured_partners_title2: "جوایز و همکاران"
#    featured_partners_blurb1: "شریک هوشمند"
#    featured_partners_blurb2: "بهترین ابزار خلاقیت برای دانش آموزان"
#    featured_partners_blurb3: "انتخاب برتر برای یادگیری"
